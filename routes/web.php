...
// Route::get('wpconnector/validate-license', [LicenseController::class, 'validateLicense']);
...
// Route::post('/webhooks/order-sync/{licenseKey}', WooOrderWebhookController::class);
